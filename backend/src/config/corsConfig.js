 ...
 *
 * This middleware is intentionally kept narrow — it only sets headers that are
 * universally safe and have no configuration overhead. A full hardening pass
 * (CSP, HSTS, Permissions-Policy) should be done at the reverse-proxy layer in
 * production so the values can be tuned per deployment environment.
 */
