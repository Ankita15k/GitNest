...
/**
 * Validates the :username route parameter on follow/unfollow and profile lookup
 * routes. Prevents oversized or malformed values from reaching the controller.
 */
